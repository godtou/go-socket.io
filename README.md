...
[![GoDoc](http://godoc.org/github.com/godtou/go-socket.io?status.svg)](http://godoc.org/github.com/godtou/go-socket.io) [![Build Status](https://travis-ci.org/godtou/go-socket.io.svg)](https://travis-ci.org/godtou/go-socket.io)

[![Coverage Status](https://coveralls.io/repos/github/godtou/go-socket.io/badge.svg?branch=v1.4)](https://coveralls.io/github/godtou/go-socket.io?branch=v1.4)

[![Go Report Card](https://goreportcard.com/badge/github.com/godtou/go-socket.io)](https://goreportcard.com/report/github.com/godtou/go-socket.io)
...
**Help wanted** This project is looking for contributors to help fix bugs and implement new features. Please check [Issue 192](https://github.com/godtou/go-socket.io/issues/192). All help is much appreciated.
...
```bash
go get github.com/godtou/go-socket.io
```

Import it with:

```go
import "github.com/godtou/go-socket.io"
```
...
import (
	...
	"github.com/godtou/go-socket.io"
)
...
<a href="https://github.com/godtou/go-socket.io/graphs/contributors">
